...
bubble_q = [
    ...
    (6.75, "AXIOM", "Nigga just shutup till we get there. Also, I'm hungry.", "droid", "right", 3.5, False),
    (12.0, "KAI", "Droids don't eat, Axiom.", "kid", "left", 2.5, False),
    (12.75,"AXIOM", "I eat lil kids....", "droid", "right", 2.5, False),
    (15.75,"KAI", "what in the actual fuck.. wtf is that.", "kid", "left", 3.0, True),
    (18.0, "BOSS", "FOOLISH CHILD. YOU DARE APPROACH ME?", "boss", "right", 3.5, True),
    (21.0, "KAI", "Axiom... what do we do?", "kid", "left", 2.5, False),
    (22.2, "AXIOM", "Nigga why u be asking a lotta questions..", "droid", "right", 2.5, False),
    (24.75,"AXIOM", "you expect me to turn myself into a gun or smthng nig-.", "droid", "right", 3.0, False),
    (27.0, "KAI", "i mean.. can you--", "kid", "left", 2.0, True),
    (28.2, "AXIOM", "might as well .", "droid", "right", 3.0, False),
    (30.0, "KAI", "wth.", "kid", "left", 2.0, False),
    (32.0, "KAI", "i be seeing shit", "kid", "left", 2.0, True),
    ...
    (49.5, "KAI", "A COW!? The final boss was a COW!?", "kid", "left", 3.0, True),
    ...
    (63.75,"COW", "moo. (finally, my ride..later biaach)", "cow", "right", 3.0, False),
    ...
    (72.0, "COW", "moo~ (later losers)", "cow", "right", 3.0, False),
    (75.0, "KAI", "grass cannot be that high.. right? what now......", "kid", "left", 3.0, False),
